...
def image_stream_start_stop(queue, imagedir, calib, stride, imstart=0, imstop=-1):
    """ image generator """
    ...
    image_list = sorted(chain.from_iterable(Path(imagedir).glob(e) for e in img_exts))[imstart:imstop:stride]
